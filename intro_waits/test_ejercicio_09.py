...
class TestLandingPage:
    ...
    def test_slow_loading_page(self):
        ...
        download = self.__find_clickable_element(By.ID, "downloadButton")
        download.click()
        self.__find_by_text(By.CLASS_NAME, "progress-label", "Complete!")
        self.__find_by_text(By.XPATH, "//*[@class='ui-dialog-buttonset']//button", "Close")
